...
module.exports = function (proto) {
  ...
  proto.distort = function distort () {
    return this.out("-distort");
  }

  // http://www.imagemagick.org/Usage/distorts/#perspective
  proto.perspective = function perspective (matrix) {
    return this.out("Perspective", matrix);
  }
  ...
  proto.autoLevel = function autoLevel() {
    return this.out("-auto-level");
  }
  
  proto.autoGamma = function autoGamma() {
    return this.out("-auto-gamma");
  }
